    ...
    public void test_trashButtonClicked_CreateTwoDataLayoutsAndClickTrashButtonOnFirst_MakeSureProperLayoutIsDeletedAndIdIsChanged() throws Throwable {
        ...
        runOnUiThread(new Runnable()
        {
            public void run()
            {
                ...
                helpers.compareWorkoutDetails1(m_MainActivity.getWorkoutDataLayoutAt(0).convertToWorkoutDetailsEntity());
                helpers.compareWorkoutDetails2(m_MainActivity.getWorkoutDataLayoutAt(1).convertToWorkoutDetailsEntity());
                ...
                workoutDataLayout.pressTrashBinButton();
                assertThat(m_MainActivity.m_tableLayout.getChildCount(), comparesEqualTo(2));
                helpers.compareWorkoutDetails2(m_MainActivity.getWorkoutDataLayoutAt(0).convertToWorkoutDetailsEntity());
            }
        });
    }
